...
export const I18nContext = createContext<{ locale: AppLocale; setLocale: (locale: AppLocale) => void; t: AppTranslate }>({
  locale: 'en-US', setLocale: () => undefined, t: fallbackTranslate,
});
